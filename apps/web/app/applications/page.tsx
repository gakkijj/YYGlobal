...
export default function ApplicationsPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl">
      ...
      <ProcessGuide current={5} completed={[0, 1, 2, 3, 4]} />
      <Card className="mb-6 border-blue-100 bg-blue-50"><p className="font-black text-blue-950">什么时候可以进入这里？</p><p className="mt-2 text-sm leading-6 text-blue-900/70">只有某个项目的官网要求已核验、所有必需材料都选择了最终版本并检查通过，该项目才能加入申请看板。</p></Card>
